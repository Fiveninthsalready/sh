...
if(answer1 === "Born Rich" && answer2 === "Boring job"){
 message.innerHTML = "You are MR KRABS. You just want money and don't care how you get it. Greedy ah ";
 buttonOne.style.display = "none";
Question1.style.display = "none";
Question2.style.display = "none";
mrkrabs.style.display = "block";
} else if (answer1 === "Work" && answer2 === "Boring job"){
 message.innerHTML = "You are SQUIDWARD. You want to work but want to get paid nicely either way";
 buttonOne.style.display = "none";
Question1.style.display = "none";
Question2.style.display = "none";
...
spongebob.style.display = "block";
    }else if (answer1 === "Born Rich" && answer2 === "Fun job"){
